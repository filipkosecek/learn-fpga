...
`define NRV_FREQ 20                 // Validated at 50 MHz on the IceStick. Can overclock to 70 MHz.
`define NRV_RESET_ADDR 32'h00821500 // Jump execution to SPI Flash (800000h, +128k(20000h) for FPGA bitstream)
